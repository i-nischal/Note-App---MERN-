  ...
  return (
    <nav className="fixed top-0 z-50 w-full backdrop-blur-md bg-white/30 border-b border-gray-200 px-4 sm:px-6 py-3 flex justify-between items-center transition-all duration-300">
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        {/* Create Note Button */}
        <button className="flex items-center justify-center gap-2 px-3 py-2 sm:px-4 sm:py-2.5 rounded-full text-sm font-semibold text-white transition-all duration-300 ease-in-out bg-indigo-600 hover:bg-indigo-700 active:scale-95 shadow-lg">
          <Plus size={16} />
